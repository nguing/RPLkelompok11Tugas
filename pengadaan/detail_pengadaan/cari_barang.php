...
<form action="cari_barang.php" enctype="multipart/form-data" name="barang" method="post" >
  <table border="0" class="table table-striped">
    <tr>
	  ...
	  <input type="hidden" name="no_faktur_f" value="<?php echo $no_faktur; ?>"
	  </td>
...
<?php	
	...
	if (isset($_POST['kirim']))
	{
		...
		$no_faktur			= isset($_POST['no_faktur_f']) ? $_POST['no_faktur_f'] : '';
		...
		foreach($masukdetailpengadaan->Que($que) as $value)
			...
			echo '
				  <tr>
					...
					<td> '.$value["satuan"].' </td>
					<td align="center"><a href="detail_pengadaan.php?no_faktur='.$no_faktur.'&id_brg='.$value["id_brg"].'&nama_barang='.$value["nama_barang"].' "><input type="button" class="form-control" value="Pilih"></a></td>
				  </tr>
				  ';
			}		
		}
