...
<form action="cari_barang.php" enctype="multipart/form-data" name="barang" method="post" >
  <table border="0" class="table table-striped">
    <tr>
	  ...
	  <input type="hidden" name="id_pagu_barang_f" value="<?php echo $id_pagu_barang; ?>"
	  </td>
...
<?php	
	...
	if (isset($_POST['kirim']))
	{
		...
		$id_pagu_barang		= isset($_POST['id_pagu_barang_f']) ? $_POST['id_pagu_barang_f'] : '';
		...
		foreach($masukdetailpagu->Que($que) as $value)
			...
			echo '
				  <tr>
					...
					<td> '.$value["satuan"].' </td>
					<td align="center"><a href="detail_pagu.php?id_pagu_barang='.$id_pagu_barang.'&id_brg='.$value["id_brg"].'&nama_barang='.$value["nama_barang"].' "><input type="button" class="form-control" value="Pilih"></a></td>
				  </tr>
				  ';
			}		
		}
